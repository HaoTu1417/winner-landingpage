    ...
    <header className="bg-black text-white">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden lg:flex space-x-4">
          <button className="bg-green-600 px-4 py-2 rounded">Mở Tài Khoản</button>
          <button className="bg-green-600 px-4 py-2 rounded">Giao Dịch Trực Tuyến</button>
        </div>
      </div>
    </header>
    ...
    <main className="bg-gray-100">
      ...
      <section className="relative bg-cover bg-center text-white h-64 sm:h-96 bg-[url('/your-image-path.jpg')] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl sm:text-5xl font-bold">Công ty Chứng khoán AGRIBANK</h1>
          <p className="mt-4 text-lg sm:text-xl">Kiến tạo một trải nghiệm đầu tư Tích lũy riêng biệt</p>
